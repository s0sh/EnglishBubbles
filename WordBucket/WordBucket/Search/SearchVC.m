...
- (void)callWikiAPI
{
    ...
    NSString *wikiurlString = [NSString stringWithFormat:@"http://%@.wiktionary.org",SharedAppDelegate.isNativeSrchLang ? [[NSUserDefaults standardUserDefaults] objectForKey:kTargetLangCode]:[[NSUserDefaults standardUserDefaults] objectForKey:kNativeLangCode]];
