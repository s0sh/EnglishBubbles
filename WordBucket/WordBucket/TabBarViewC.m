...
- (void)dataReloaded:(NSNotification *)notification {
    ...
    if ([wordStr isEqualToString:[Common setLanguageOniCloudFile]])
        return;
    ...
    self.wordNew.addedWord = [Common setLanguageOniCloudFile];
...
- (void)loadData:(NSMetadataQuery *)query {
    ...
    if ([query resultCount] == 1) {
        ...
        doc.addedWord = [Common setLanguageOniCloudFile];
        self.wordNew = doc;
