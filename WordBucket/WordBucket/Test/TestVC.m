...
- (IBAction)searchClicked:(id)sender {
    ...
    */
    ...
    else
    {
        ...
        list.strSearchWord = [_txtSearch.text lowercaseString];
...
- (IBAction)wishListButtonClicked:(id)sender {
    ...
    NSString *nib = SharedAppDelegate.isPhone5 ? @"OfflineWishlistVC" : @"OfflineWishlistVCiPhone4";
    OfflineWishlistVC *listVC = [[OfflineWishlistVC alloc] initWithNibName:nib bundle:nil];
    listVC.strSearchWord = @"";
