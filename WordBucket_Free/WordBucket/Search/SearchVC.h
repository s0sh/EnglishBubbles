...
@interface SearchVC : GAITrackedViewController<UITextFieldDelegate,MFMailComposeViewControllerDelegate,ActionSheetDelegate,WebserviceDelegate,AVAudioPlayerDelegate,UIActionSheetDelegate,ADBannerViewDelegate>{
    DBHelper *dbHelper;
