...
//    arrLanguages = [NSArray arrayWithObjects:@"Chinese",@"Dutch",@"English",@"French",@"German",@"Hindi",@"Irish",@"Japanese",@"Spanish", nil];
    ...
    arrTargetLanguages = [[NSMutableArray alloc] initWithObjects:NSLocalizedString(@"English", nil), nil];
    
//    arrNativeLanguages = [dbHelper fetchRecordFromDB:@"tbl_Language" withField:@"languageName"];
...
//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Done" style:UIBarButtonItemStyleDone target:self action:@selector(done:)];
    ...
    NSString *abcString = NSLocalizedString(@"ABC", nil);
...
//    NSArray *arrLangs = [[arrLanguages objectAtIndex:indexPath.row] componentsSeparatedByString:@"/|"];
    ...
    else
    {
        ...
        //[pickerInfo setBackgroundColor:[UIColor redColor]];
...
{
//    NSArray *arrLangs = [[arrLanguages objectAtIndex:indexPath.row] componentsSeparatedByString:@"/|"];
//    [UserDefaluts setObject:[arrLangs objectAtIndex:1] forKey:@"targetLanguageCode"];
...
-(IBAction)finish:(id)sender
{
    ...
    else
    {
        ...
        [SharedAppDelegate.tracker send:[[GAIDictionaryBuilder createEventWithCategory:@"User_Login" action:@"Login_Action" label:@"WordBucket" value:nil] build]];
